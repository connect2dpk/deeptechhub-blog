...
export default function BlogCard({ post }: BlogCardProps) {
  return (
    <Link href={`/blog/${post.slug}`}>
      <article className="group border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden hover:shadow-lg dark:hover:shadow-lg dark:hover:shadow-blue-500/10 transition-all duration-300 hover:border-blue-400 dark:hover:border-blue-500 cursor-pointer">
